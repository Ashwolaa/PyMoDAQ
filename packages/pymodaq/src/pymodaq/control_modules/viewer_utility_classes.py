...
params = [
    {'title': 'Main Settings:', 'name': 'main_settings', 'expanded': False, 'type': 'group', 'children': [
        ...
        {'title': 'N Acquisitions:', 'name': 'Naverage', 'type': 'int', 'default': 1, 'value': 1, 'min': 1},
        {'title': 'Acq. mode:', 'name': 'acq_mode', 'type': 'list',
         'limits': ['Average', 'Sum'], 'value': 'Average'},
        {'title': 'Show steps:', 'name': 'show_averaging', 'type': 'bool', 'default': False, 'value': False},
