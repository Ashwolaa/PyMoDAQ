...
class GlobalScanner(QObject, ParameterManager,ActionManager):                    
    ...
    def __init__(self, parent_widget: QtWidgets.QWidget = None, actuator = None, scanner_type: str = None
        ...
        self._scanner: ScannerBase = scanner_factory.get('Tabular','Linear',actuators=self.actuator)   
        self.setup_ui()
    ...
    def updateScanner(self,):
        ...
        self._scanner: ScannerBase = scanner_factory.get('Tabular',self.scanType.currentText(),actuators=[self.actuator])  
